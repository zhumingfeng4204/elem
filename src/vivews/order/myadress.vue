<template>
  <div class="myAddress">
    ...
    <div class="address-view">
      <div class="address-card" v-for="(address,index) in alladress" :key="index">
        <div class="address-card-select">
          <i class="fa fa-check-circle" v-if="xiabiao1==index"></i>
        </div>
        <div class="address-card-body" @click="setaddressinfo(index)">
